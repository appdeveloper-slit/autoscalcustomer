...
void main() => runApp(CompletedLeadDetails());

class CompletedLeadDetails extends StatefulWidget {
  @override
  State<CompletedLeadDetails> createState() => _CompletedLeadDetailsState();
}

class _CompletedLeadDetailsState extends State<CompletedLeadDetails> {
            ...
            children: [
              ...
              Container(
                padding: EdgeInsets.symmetric(
                    vertical: Dim().d16, horizontal: Dim().d68),
                decoration: BoxDecoration(
                  gradient: LinearGradient(
                    colors: [Color(0xffE48260), Color(0xFFB81736)],
                  ),
                ...
                child: InkWell(
                  onTap: () {
                    // STM().redirect2page(ctx, CancelledLeadDetails());
                  },
                  child: Text(
                    'Download Report',
